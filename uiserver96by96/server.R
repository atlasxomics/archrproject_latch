...
scBubbHeat <- function(
  inpConf, inpMeta, inp, inpGrp, inpPlt, 
...
shinyServer(function(input, output, session) { 
  ...
  output$sc1a2oup1.ui <- renderUI({ 
    plotOutput("sc1a2oup1", height = 600, width = 800) 
  }) 
  ...
  output$sc1a2oup2.ui <- renderUI({ 
    plotOutput("sc1a2oup2", height = 600, width = 800) 
  }) 
  ...
  output$sc1a3oup1.ui <- renderUI({ 
    plotOutput("sc1a3oup1", height = 600, width = 800) 
  }) 
  ...
  output$sc1a3oup2.ui <- renderUI({ 
    plotOutput("sc1a3oup2", height = 600, width = 800) 
  }) 
  ...
  output$sc2a3oup1.ui <- renderUI({
    plotOutput("sc2a3oup1", height = 600, width = 800)
  })
  ...
  output$sc2a3oup2.ui <- renderUI({
    plotOutput("sc2a3oup2", height = 600, width = 800)
  })
