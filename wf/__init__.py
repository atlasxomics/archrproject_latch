    ...
    parameters={
        'runs': LatchParameter(
            ...
            description='List of runs to be analyzed; each run must contain a \
                         ...
                         spatial folder for SpatialDimPlot. Note that multiple Coditions must be separted by -, for example: Non_responder-post_treatment-One_month.
Do not use spaces in each condition! For example, thess examples are WRONG: Non responder-post treatment  OR Non responder - post treatment',
