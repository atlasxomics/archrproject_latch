...
shinyUI(
  fluidPage(
    tags$head(
      tags$style(
        HTML(".shiny-output-error-validation {color: red; font-weight: bold;}")
      )
    ),
    list(
      tags$style(
        HTML(
          paste0(
            ".navbar-default .navbar-nav { font-weight: bold; font-size: ",
            "16px; background-color:#D3D3D3; }"
          )
        )
      ),
      navbarPage(
        ...
        NULL,
        ### Tab1.a1: Metadata vs geneAccs
        tabPanel(
          HTML("Metadata vs GeneAccs"),
          h4("Cell information vs gene accessibility on reduced dimensions"),
          "In this tab, users can visualize both cell information and gene ",
                  ...
                  sidebarPanel(
                    ...
                    selectInput(
                      ...
                      choices = sc1conf[
                        -c(
                          which(
                            sc1conf$dimred == TRUE & grepl("_2", sc1conf$UI)
                          )
                        ),
                      ][dimred == TRUE]$UI, selected = sc1def$dimred[1]
                    ),
                    selectInput(
                      "sc1a1inp1",
                      "Cell information:",
                    ...
                    conditionalPanel(
                      ...
                      radioButtons(
                        ...
                        choices = c(
                          "White-Red", "Blue-Yellow-Red", "Yellow-Green-Purple"
                        ),
                      ...
                      checkboxInput(
                        "sc1a1lab1", "Show cell info labels", value = TRUE
                      )
                    ),
                    br(),
                    br(),
                    ...
                    downloadButton(
                      "sc1a1oup1.pdf",
                      "Download PDF",
                      style = "width:123px;font-size: 13px;"
                    ),
                    downloadButton(
                      "sc1a1oup1.png",
                      "Download PNG",
                    ...
                    br(),
                    actionButton(
                      "sc1a1tog9", "Toggle to show cell numbers / statistics"
                    ),
                    conditionalPanel(
              ...
              fluidPage(
                sidebarLayout(
                  sidebarPanel(
                    ...
                    selectInput(
                      "sc1a1inp2", "Gene name:", choices = NULL
                    ) %>% helper(
                      type = "inline",
                      size = "m",
                      fade = TRUE,
                      ...
                      content = c(
                        "Select gene to colour cells by gene accessibility",
                        paste0(
                          "- Gene accessibility are coloured in a ",
                    ...
                    conditionalPanel(
                      ...
                      fluidRow(
                        ...
                        column(
                          ...
                          checkboxInput(
                            "sc1a1txt", "Show axis text", value = FALSE
                          )
                        )
                      )
                    ),
        ...
        tabPanel(
          ...
          "In this tab, users can visualize cell information side-by-side ",
                  ...
                  sidebarPanel(
                    ...
                    selectInput(
                      ...
                      helper(
                        ...
                        content = c(
                          "Select cell information to colour cells",
                          "- Categorical covariates have a fixed colour ",
                          "palette",
                          paste0(
                            "- Continuous covariates are coloured in a ",
                            "Blue-Yellow-Red colour scheme, which can be ",
                    ...
                    conditionalPanel(
                      ...
                      checkboxInput(
                        "sc1a2lab2", "Show cell info labels", value = TRUE
                      )
                    ),
                    br(),
                    br(),
                    ...
                    conditionalPanel(
                      ...
                      fluidRow(
                        ...
                        column(
                          ...
                          checkboxInput(
                            "sc1a2txt", "Show axis text", value = FALSE
                          )
                        )
                      )
                    ),
        ...
        tabPanel(
          ...
          "In this tab, users can visualise two gene accessibilities ",
              ...
              fluidPage(
                sidebarLayout(
                  sidebarPanel(
                    ...
                    selectInput(
                      "sc1a3inp1", "Gene name:", choices = NULL
                    ) %>% helper(
                      type = "inline",
                      size = "m",
                      fade = TRUE,
              ...
              fluidPage(
                sidebarLayout(
                  sidebarPanel(
                    ...
                    selectInput(
                      "sc1a3inp2", "Gene name:", choices = NULL
                    ) %>%  helper(
                      type = "inline",
                      size = "m",
                      fade = TRUE,
                    ...
                    conditionalPanel(
                      ...
                      fluidRow(
                        ...
                        column(
                          ...
                          checkboxInput(
                            "sc1a3txt", "Show axis text", value = FALSE
                          )
                        )
                      )
                    ),
        ...
        tabPanel(
          ...
          "In this tab, users can visualize the average coAccsessibility of",
          "programs (gene sets) on low-dimensional representions.",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                ...
                downloadButton("sc1b2oup1.png", "Download PNG"),
                br(),
                div(
                  style = "display:inline-block",
                  numericInput(
              ...
              mainPanel = mainPanel(
                h4(htmlOutput("sc1b2oupTxt")), uiOutput("sc1b2oup1.ui")
              )
            )
          )
        ), # End of tab
        ...
        tabPanel(
          ...
          "In this tab, users can visualize the gene accessibility or ",
          "continuouscell information (e.g. Number of Fragment / TSS) across ",
          "groups of cells (e.g. libary / clusters).",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                selectInput(
                  ...
                  helper(
                    ...
                    content = c(
                      ...
                      "- Single cells are grouped by this categorical ",
                      "covariate - Plotted as the X-axis of the violin plot /",
                      " box plot"
                    )
                  ),
                selectInput(
                  ...
                  helper(
                    ...
                    content = c(
                      ...
                      "- Can be continuous cell information (e.g. nFragments",
                      "/ TSS)- Can also be gene accessibility"
                    )
                  ),
                radioButtons(
                  "sc1c1typ",
                ...
                actionButton(
                  "sc1c1togL", "Toggle to subset cells/ Update Color"
                ),
                conditionalPanel(
                  ...
                  actionButton(
                    "sc1c1sub1non", "Deselect all groups",
                    class = "btn btn-primary"
                  )
                ),
                br(),
              ...
              mainPanel = mainPanel(plotOutput("sc1c1oup"))
            )
          )    # End of page
        ),     # End of tab
        ...
        tabPanel(
          ...
          "based on one discrete cell information across another discrete cell",
          "information. Usage examples include the library or cellcycle",
          "composition across clusters.",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                ...
                selectInput(
                  ...
                  helper(
                    ...
                    content = c(
                      "Select categorical cell information to group / colour ",
                      "cells by - Proportion / cell numbers are shown in ",
                      "different colours"
                    )
                  ),
                radioButtons(
                ...
                checkboxInput(
                  "sc1c2flp", "Flip X/Y", value = FALSE
                ),
                actionButton(
                  "sc1c2togL", "Toggle to subset cells/ Update Color"
                ),
                conditionalPanel(
              ...
              mainPanel = mainPanel(plotOutput("sc1c2oup"))
            )
          )
        ),
        ### Tab.de1: DE Volcano Plot
        tabPanel(
          HTML("DE Volcano Plot"),
          "In this tab, users can visualize the volcano plot for marker gene",
          "differential accessibility. Important Note: if one cluster shows ",
          "more than 90 percent of one condition (check Proportion plot tab)",
          ", volcano plot will not be calculated for that cluster!",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                selectInput("sc1de1inp", "Cluster", choices = NULL),
                br(),
                selectInput("sc1de1grp", "Group Name", choices = NULL),
                br(),
                downloadButton("sc1de1oup.pdf", "Download PDF"),
                downloadButton("sc1de1oup.png", "Download PNG"),
                br(),
                div(
                  style = "display:inline-block",
                  numericInput(
              ...
              mainPanel = mainPanel(plotOutput("sc1de1oup"))
            ),
          )    # End of fluidPage
        ),     # End of tab
        ### Tab1.d1: Gene Access Heatmap
        tabPanel(
          HTML("Gene Access Heatmap"),
          h4("Gene accessibility heatmap"),
          "In this tab, users can visualise the gene accessibility patterns ",
          "of multiple genes grouped by categorical cell information (e.g. ",
          "library/cluster). ",
          br(),
          "The normalised accessibility are averaged, log-transformed and ",
          "then plotted.",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                selectInput(
                  ...
                  helper(
                    ...
                    content = c(
                      "Select categorical cell information to group cells by",
                      "- Single cells are grouped by this categorical ",
                      "covariate - Plotted as the X-aqxis of the heatmap"
                    )
                  ),
                radioButtons(
                  "sc1d1plt",
                ...
                checkboxInput(
                  "sc1d1row", "Cluster rows (genes)", value = FALSE
                ),
                checkboxInput(
                  "sc1d1col", "Cluster columns (samples)", value = FALSE
                ),
                br(),
                  ...
                  sidebarPanel(
                    ...
                    selectInput(
                      ...
                      choices = sc2conf[
                        -c(
                          which(
                            sc2conf$dimred == TRUE & grepl("_2", sc2conf$UI)
                          )
                        ),
                      ][dimred == TRUE]$UI,
                    ...
                    conditionalPanel(
                      ...
                      fluidRow(
                        ...
                        column(
                          ...
                          checkboxInput(
                            "sc2a3txt", "Show axis text", value = FALSE
                          )
                        )
                      )
                    ),
          ...
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                ...
                checkboxInput(
                  "sc2d1row", "Cluster rows (genes)", value = FALSE
                ),
                checkboxInput(
                  "sc2d1col", "Cluster columns (samples)", value = TRUE
                ),
                br(),
                ...
                downloadButton("sc2d1oup.png", "Download PNG"),
                br(),
                div(
                  style = "display:inline-block",
                  numericInput(
        ...
        ### Tab1.d1: Motifs Volcano
        tabPanel(
          HTML("Motifs DE Volcano Plot"),
          "In this tab, users can visualise the volcano plot for marker motifs",
          "enrichments differentially",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                selectInput("sc2de1inp", "Cluster", choices = NULL),
                br(),
                selectInput("sc2de1grp", "Group Name", choices = NULL),
                br(),
                downloadButton("sc2de1oup.pdf", "Download PDF"),
                downloadButton("sc2de1oup.png", "Download PNG"),
                br(),
                div(
                  style = "display:inline-block",
                  numericInput(
              ...
              mainPanel = mainPanel(plotOutput("sc2de1oup"))
            ),
          )     # End of fluidPage
        ),      # End of tab
        ...
        tabPanel(
          ...
          h4("Motifs logo Plot"),
          "In this tab, users can visualise the Motifs logo plot for marker",
          ...
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                ...
                downloadButton("sc2logooup.png", "Download PNG"),
                br(),
                div(
                  style = "display:inline-block",
                  numericInput(
              ...
              mainPanel = mainPanel(plotOutput("sc2logooup"))
            )
          )    # End of fluidPage
        ),     # End of tab
        ### Genome Tracks
        tabPanel(
          HTML("Genome Tracks"),
          h4("Genome Tracks"),
          "In this tab, users can visualise the genome browser for gene ",
          "accessibility",
          br(),
          br(),
          fluidPage(
            sidebarLayout(
              sidebarPanel(
                ...
                downloadButton("sc1trackoup.png", "Download PNG"),
                br(),
                div(
                  style = "display:inline-block",
                  numericInput(
