...
shinyUI(
  fluidPage(
    ...
    list(
      tags$style(
        HTML(
        ".navbar-default .navbar-nav { font-weight: bold; font-size: 16px; background-color:#D3D3D3; }"
        )
      )
    ),
    navbarPage(
      ...
      tabPanel(
        ...
        "In this tab, users can visualize the gene accessibility or continuous",
        "cell information (e.g. Number of Fragment / TSS) across groups of ",
        "cells (e.g. libary / clusters).",
        br(),
        br(),
        fluidPage(
          sidebarLayout(
            sidebarPanel(
              ...
              conditionalPanel(
                ...
                actionButton(
                  "sc1c1sub1all", "Select all groups", class = "btn btn-primary"
                ),
                actionButton(
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              conditionalPanel(
                ...
                actionButton(
                  "sc1c2sub1all", "Select all groups", class = "btn btn-primary"
                ),
                actionButton(
                  "sc1c2sub1non",
                  "Deselect all groups",
      ...
      tabPanel(
        ...
        "differential accessibility. Important Note: if one cluster shows more",
        " than 90 percent of one condition (check Proportion plot tab), ",
      ...
      tabPanel(
        ...
        "multiple genes grouped by categorical cell information (e.g. library",
        "/ cluster). ",
        br(),
        "The normalised accessibility are averaged, log-transformed and then ",
        "plotted.",
        br(),
        br(),
        fluidPage(
          sidebarLayout(
            sidebarPanel(
              ...
              conditionalPanel(
                ...
                actionButton(
                  "sc1d1sub1all", "Select all groups", class = "btn btn-primary"
                ),
                actionButton(
                  "sc1d1sub1non",
                  "Deselect all groups",
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              conditionalPanel(
                ...
                actionButton(
                  "sc2d1sub1all", "Select all groups", class = "btn btn-primary"
                ),
                actionButton(
                  "sc2d1sub1non",
                  "Deselect all groups",
